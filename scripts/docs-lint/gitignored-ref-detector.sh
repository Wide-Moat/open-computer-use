...
# follow. If a doc cites `sandboxd/foo.md` or `references/bar.zip` — both
# gitignored — the reader sees a dead link and the architecture becomes
# self-referential to a private working directory.
#
