...
| Upload, download, delete, or preview later disputed | P4-artifact-R2 (NFR-SEC-79, SEC-09) | OCSF event per operation, fail-closed, under host-attested identity, before the response. Residual: binding OCSF `actor` to the embed-asserted principal — [#181](https://github.com/Wide-Moat/open-computer-use/issues/181). |
