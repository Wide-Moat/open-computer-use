...
| Scope enforcement | storage engine validates the JWT claim; mismatch → 401 from origin | egress-side per-destination / per-claim scope at the hop |
