...
- The count of containers stays an observation, not an invariant — the later Artifact-plane carve-out ([ADR-0015](0015-storage-decomposition-by-trust-plane.md)) and any future deployable add a repository row without an ADR rejecting them on "it would be the Nth container".
