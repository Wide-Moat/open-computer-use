...
A purchase requires alignment across four parallel chains, each with veto power:

1. **Business sponsor and budget** — Chief AI Officer where the title exists (HSBC, UBS, CBA, NatWest as of 2026); the function exists at every tier-1 by end-2026 even where the title does not.
