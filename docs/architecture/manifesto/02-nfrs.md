...
| NFR-PERF-03 | Session-create p99, cold-start on microVM substrate | ≤2 s | k6 perf gate | [`10-observability.md`](../../future-architecture/architecture/10-observability.md) §SLO |
